...
## Insights Deep Dive
### Funding
* Since 2011, a **total of 2,804 projects have been funded**, with an average project lifecycle of 5.4 years, highlighting a long-term investment strategy.
* The **projects are primarily financed through credits (74%) and grants (24%)**, totaling $248 billion and $81 billion, respectively. With a majority of projects financed through credits, it indicates that most projects are expected to generate sufficient returns to repay borrowed funds.
...
* With a grace period of 5 to 10 years before credit repayment begins, **only a few projects have entered the repayment phase, resulting in a low overall repayment ratio of 7%.** Thus, repayment performance cannot yet be fully evaulated.
...
* With **1,613 projects and $214 billion in total funding, the Middle East and Africa region holds the largest project portfolio**, primarily composed of credits (74%) and grants (24%). This highlights the strategic priority of sustained, long-term development initiatives in the Middle East and Africa region.
